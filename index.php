        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
           <!-- BOTOES ADICIONAIS
            ...
            <li class="nav-item"> <a class="nav-link" href="#"><img class="rounded-circle" src="images/336583.png" alt="Loja" width="30" height="30" id="imagem" title="Loja" />&nbsp;Loja</a> </li>
            <li class="nav-item"> <a class="nav-link" href="Classes/View/Contato/ContatoChayds.php"><img title="Suporte" class="rounded-circle" src="images/support3.png" width="30" height="30" />&nbsp;Contato</a></li>
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				<?php
				if(isset($_SESSION['usuarioNome']) && $_SESSION['usuarioNome'] != null)
				{ ?>
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href='Classes/View/Alterar/AlterarUsuarioCompra.php?idPessoa=<?php echo $_SESSION['usuarioId'];?>'><img title="alterar informações do usuario" class="rounded-circle" src="images/124654893.png" width="35" height="37" />&nbsp;&nbsp;&nbsp;Alterar informações</a>
                <div class="dropdown-divider"></div>
			<table>
			<?php
			...
			?>
			  <tr>
				<td><a class="dropdown-item" href="Classes/View/Loja/ConfirmarCompraCarrinho.php"><img class="rounded-circle" src="images/carrioverde<?php echo $contadorCarrinho; ?>.png" alt="foto de perfil" width="43" height="33" id="imagem" title="Carrinho de compras" />&nbsp;Carrinho de compras</a>
				  </td>
			  </tr>
		<?php 
				$contadorMensagem = 0;
	...
	<div align="center" class="dropdown-menu" aria-labelledby="navbarDropdown">
		...
		<table align="center">
		  ...
		  <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img title="Redes sociais" class="rounded-circle" src="images/1488003.png" width="30" height="30" />&nbsp;Redes Sociais</a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="Classes/View/Posts/Instagram.php"><img title="Instagram" class="rounded-circle" src="images/1.gif" width="30" height="30" />&nbsp;Instagram</a>
				<div class="dropdown-divider"></div>
                <a class="dropdown-item" href="Classes/View/Posts/FacebookPosts.php"><img title="Instagram" class="rounded-circle" src="images/2.gif" width="30" height="30" />&nbsp;Facebook</a>
                <div class="dropdown-divider"></div>
				<a class="dropdown-item" href="Classes/View/Videos/Videos.php"><img title="Instagram" class="rounded-circle" src="images/quanto-custa-anunciar-no-youtube.png" width="30" height="30" />&nbsp;Youtube</a>
				<div class="dropdown-divider"></div>
				<a class="dropdown-item" href="Classes/View/Posts/Twitter.php"><img title="Twitter" class="rounded-circle" src="../../../images/3.gif" width="30" height="30" />&nbsp;Twitter</a>
              </div>
            </li>
	<?php
	...
	{ $contador = $contador + 1; $auxContador ++; ?>
		...
		<form name="formCompraCarrinho" action="#" target="_self" method="post" enctype="multipart/form-data">
		  ...
		  <a href='Classes/View/Loja/produto.php?idProduto=<?php echo $dados['idProduto'];?> '>
			...
			<div class="dropdown-divider"></div>
              <p class="card-text"><?php echo $dados['descricaoProduto']; ?><br><div class="dropdown-divider"></div><h3>R$ <?php echo $dalProduto->virgula($dados['precoVenda']); ?></h3></p>
...
>>>>>>> 0c46a80bdf6c13191d2b3a498f436e8d55387707
</html>