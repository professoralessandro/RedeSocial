        ...
        <body>
            ...
            <div class="container">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 mb-2 text-center">
                            <h2>AMIGOS DE <?php echo(strtoupper($dalUsuario->primeiroNome($_SESSION['usuarioNome']))); ?> </h2>
                        </div>
                    </div>
                </div>
                <hr>
                                        ...
                                        <div class="text-center col-12">
                                            ...
                                            <form id="feedbackForm" class="text-center">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control text-center" id="name" name="name" placeholder="Nome:" aria-describedby="nameHelp">
                                                    <span id="nameHelp" class="form-text text-muted" style="display: none;">Please enter your name.</span>
                                                </div>
                                                <div class="form-group">
                                                    <label for="email">E-Mail</label>
                                                    <input type="email" class="form-control text-center" id="email" name="email" placeholder="Email:" aria-describedby="emailHelp">
                                                    <span id="emailHelp" class="form-text text-muted" style="display: none;">Please enter a valid e-mail address.</span>
                                                </div>
                                                <div class="form-group">
                                                    <label for="message">Mensagem</label>
                                                    <textarea rows="10" cols="100" class="form-control text-center" id="message" name="message" placeholder="Mensagem:" aria-describedby="messageHelp"></textarea>
                                                    <span id="messageHelp" class="form-text text-muted" style="display: none;">Please enter a message.</span>
                                                </div>
                                                <button type="submit" id="feedbackSubmit" class="btn btn-block btn-lg btn-primary"> Enviar</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
