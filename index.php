...
<body>
  ...
  <!-- About -->
<form name="formDeslogar" action="Classes/Conexao/sair.php" target="_self" method="post" >
  <section id="about" class="home-section bg-white">
    <div class="container">
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
            <h2>About us: <?php if(isset($_SESSION['usuarioNome'])){ echo("SEJA BEM VINDO ".$_SESSION['usuarioNome']); ?>
			<input align="right" class="btn btn-danger" type="submit" value="Sair" name="logof" />
            <input hidden="hidden" name="deslogar" />
            <?php }?></h2>
      ...
      <div class="row wow fadeInUp">
         <?php if(isset($_SESSION['usuarioImagem'])){ echo("SEJA BEM VINDO ".$_SESSION['usuarioNome']); ?>
         <div class="col-md-6 about-img">
          <img src="imagens/<?php echo($_SESSION['usuarioImagem']); ?>" alt="<?php echo($_SESSION['nome']); ?>">
        </div>
		  <?php }
				else
				{
...
<?php }
	  ...
	  {
	?>
   <form name="formLogar" action="#" target="_self" method="post" >
    <section id="content">
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-sm-offset-4 col-md-4 col-md-offset-4">
            <div class="page-login-form box">
              ...
              <form role="form" class="login-form">
                ...
                <button name="login" class="btn btn-common log-btn">Submit</button>
              </form>
              <ul class="form-links">
