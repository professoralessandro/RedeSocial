...
//LOGAR
    ...
    public function Deslogar() {
        unset(
                $_SESSION['usuarioId'], $_SESSION['usuarioNome'], $_SESSION['usuarioNascimento'], $_SESSION['usuarioCadastro'], $_SESSION['usuarioEmail'], $_SESSION['usuarioAcessoNiveis'], $_SESSION['usuarioTelDDD'], $_SESSION['usuarioTelefone'], $_SESSION['usuarioSexo'], $_SESSION['usuarioImagem']
        );
    }
